...
**Version** 0.1.0-s18c · **Bun** 1.4.0 · **Date** 2026-08-31T15:08:57.830Z · **Tokenizer** o200k_base
...
| `page.lcp` | 132 ms | — | report | worst /category/engineering/ @ 390; localhost, unthrottled — the shape of the page, not a field number; report-only |
...
| `desk.lcp` | 216 ms | — | report | worst /_snypd/review/post/a-draft-in-flight @ 1280; localhost, unthrottled — the shape of the page, not a field number; report-only |
...
| `desk.first.lcp` | 160 ms | — | report | worst / @ 1280; localhost, unthrottled — the shape of the page, not a field number; report-only |
