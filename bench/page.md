...
**Version** 0.1.0-s18c · **Bun** 1.4.0 · **Date** 2026-08-28T17:34:00.576Z · **Tokenizer** o200k_base
...
| `page.lcp` | 164 ms | — | report | worst /posts/every-primitive-once/ @ 1280; localhost, unthrottled — the shape of the page, not a field number; report-only |
...
| `desk.lcp` | 140 ms | — | report | worst /_snypd @ 1280; localhost, unthrottled — the shape of the page, not a field number; report-only |
