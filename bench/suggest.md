...
**Version** 0.1.3 · **Bun** 1.4.0 · **Date** 2026-09-06T09:41:57.678Z · **Tokenizer** o200k_base
...
| `suggest.ms` | 14.49 ms | — | report | per post: parse + shapes + score + verify (the verify pass lints each candidate against the document it would land in) |
...
```
precision 1.000 (17/17)  ·  recall 1.000 (17/17)  ·  20 posts  ·  5.01 ms/post
```
