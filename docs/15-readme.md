...
| 3 | **Start here** | `mkdir · bunx @snypd/cli init · claude · "Write me a first post."` (docs/08 decision 178, 16 Sep — the paste sentence became the second door); the five platforms by name (docs/10 §9: every Bun platform) | `packaging/` |
