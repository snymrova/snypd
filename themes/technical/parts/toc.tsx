/**
 * The contents list (U6b) — the part `base` declares empty and this theme fills. This is the one thing
 * `technical` wanted that the theme contract did not already have, and the whole of what it needed was a
 * slot in the post layout and the heading tree on the page; no layout is forked, which is D8.
 *
