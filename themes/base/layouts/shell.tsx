...
export interface ShellProps { ctx: SiteCtx; title: string; description?: string; markdownUrl?: string; route: string; children: Html }

export default function Shell({ ctx, title, description, markdownUrl, route, children }: ShellProps): Html {
